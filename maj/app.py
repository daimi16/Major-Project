...
def run():
    ...
    add_bg_from_local('back2.jpg')
    
    

    img_file = st.file_uploader("Upload an Image of a Bird", type=["jpg", "png","jpeg"])
    if img_file is None:
           st.text("Please upload an image file")
             ...
             if st.button("Predict"):
                    with st.spinner('Prediction Under Progress'):
                           predictions = upload_predict(image, model)
                    st.success("The image is classified as "+predictions)
